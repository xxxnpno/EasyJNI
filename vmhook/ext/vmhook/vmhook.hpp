...
namespace vmhook
{
    ...
    */
        ...
        -> void
    {
        ...
        try
        {
            std::lock_guard<std::mutex> lock{ detail::dispatch_mutex };
            detail::dispatch_queue.push_back(std::move(task));
        }
    ...
    */
        ...
        -> void
    {
        ...
        const bool previous_in_detour{ detail::in_detour };
        detail::in_detour = true;
        ...
        while (true)
        {
            ...
            {
                std::lock_guard<std::mutex> lock{ detail::dispatch_mutex };
                if (detail::dispatch_queue.empty())
                {
                    break;
                }
                local.swap(detail::dispatch_queue);
            }
            catch (...)
            {
        ...
        detail::in_detour = previous_in_detour;
        draining = false;
    }
